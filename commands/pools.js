...
module.exports.run = async (bot, message) => {
    ...
    if(check == config.configs.chID) {
        const poolsUSAEmbed = new Discord.MessageEmbed()
        ...
        .addField('\u200b', '\u200b')
        message.channel.send(poolsUSAEmbed)
        const poolsBEEmbed = new Discord.MessageEmbed()
        .setTitle("LOUD Mining Pool Info")
        .setColor("#00720D")
        .setThumbnail(URL = "https://loudmining.com/media/lm-be.png")
        ...
        return message.channel.send(poolsBEEmbed)
    }
